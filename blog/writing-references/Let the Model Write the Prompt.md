...
Presentation title slide "Let the Model Write the Prompts - An Intro to DSPy" by Drew Breunig

Quote about regular expressions creating two problems
```
"Some people, when confronted with
a problem, think 'I know, I'll use
regular expressions.' Now they have
two problems."
-Jamie Zawinsky, somewhat apocryphally
```
...
Same quote but replacing "regular expressions" with "prompting"
...
Comparison chart showing pros and cons of prompting with happy and sad emoji
...
Visualization showing breakdown of SWE-Bench prompt components with percentages
...
Code editor screenshot showing Python prompting instructions
...
Speaker introduction slide for Drew Breunig with professional background
...
Map visualization showing San Francisco with Overture Maps Foundation description
...
Grid of company logos showing Overture Maps Foundation members
...
Map showing Databricks location with places data description
...
Three icons representing data entry, regional names, and geocoding challenges
...
Pipeline diagram showing progression from spatial clustering to LLM comparison
...
Title slide introducing DSPy as solution for turning prompting into programming
...
Philosophical statement about future improvements in AI strategies and models
...
Three-pillar diagram showing DSPy's approach to decoupling tasks from LLMs
...
Visual breakdown of prompt components using colored blocks
...
Explanation of DSPy signatures and modules with icons
...
Code example showing basic DSPy implementation
...
System prompt example showing how signatures become prompts
...
User prompt example showing input formatting
...
ChainOfThought module example with reasoning field
...
Grid showing various DSPy module types available

There are many different modules. You could even write your own.

Code example defining Place and PlaceMatcher signature classes
...
Code showing how to call the PlaceMatcher with example results
...
Another prompt component breakdown visualization
...
Code example showing ReAct module with tool definitions
...
Prompt component breakdown highlighting tool definitions
...
Code showing DSPy optimization process with MIPROv2
...
Three-step MIPROv2 process diagram with icons
...
Generated instruction text showing detailed place matching criteria
...
Prompt breakdown emphasizing detailed context and instructions

Running an optimization completed our list of prompt components. But did it work?

Results showing performance improvement from 60.7% to 82.0% with code snippet
...
Comparison of model performance across Qwen, Llama, and Phi models
...
Takeaways slide with four key points about using DSPy
...
Repeat of three-pillar DSPy framework diagram
...
Future improvements list including new optimizers and fine-tuning
...
Three QR codes with action items for getting started
